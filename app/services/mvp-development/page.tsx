...
export default function MVPDevelopment() {
  ...
  const capabilities = [
    { title: "Modular Feature Isolation", desc: "We structure core functions as isolated, hot-swappable code modules. This allows your startup to completely pivot specific business logics instantly without risking foundational system stability.", icon: "🧩" },
    { title: "Rapid Validation Frameworks", desc: "Every intake pipeline and application parameter is wired with clean, standalone validation matrices, reducing configuration bugs during high-frequency early iterations.", icon: "⚡" },
    { title: "Clean, Handoff-Ready Codebase", desc: "We enforce strict semantic linting rules and complete internal type definitions. Your code is left perfectly clear so that future engineering expansions read smooth from day one.", icon: "🐙" },
    { title: "Hyper-Optimized Edge Provisioning", desc: "By using lightweight build-time optimization layers, your minimum viable product deploys globally with sub-second delivery to maximize initial pitch metrics.", icon: "🚀" }
  ];

  const executionSteps = [
    { num: "01", title: "Feature Scoping & Priority Pruning", desc: "We strip away speculative clutter to isolate your product's core value proposition, locking down the exact technical requirements needed for market launch." },
    { num: "02", title: "Rapid Database Schema Blueprinting", desc: "Architecting a highly flexible relational data model using Prisma and PostgreSQL to ensure smooth structural additions during continuous pivots." },
    { num: "03", title: "High-Velocity Sprint Integration", desc: "Deploying production-ready frontend visual wrappers alongside functional backend routes through rapid Next.js decoupling patterns." },
    { num: "04", title: "Security Screening & Stability Gates", desc: "Running essential API endpoint parameter sanitation sweeps under standard OWASP validation profiles to shield early transaction layers." },
    { num: "05", title: "Seamless Edge Launch & Handoff", desc: "Pushing live deployments straight to edge server arrays while supplying complete documentation logs to your administrative stakeholders." }
  ];

  const subTechs = [
    { title: "Frontend Engine", tools: "Next.js, React Hooks, Tailwind CSS, Lucide Component Icons" },
    { title: "Backend & Routing", tools: "Node.js Runtimes, TypeScript Logic Layer, REST APIs, GraphQL" },
    { title: "Database Systems", tools: "PostgreSQL, Supabase Relational Layers, Prisma ORM, Redis" },
    { title: "Deployment Stacks", tools: "Vercel Continuous Edge Networks, Docker Containers, Git Hooks" }
  ];

  const serviceFaqs = [
    { q: "How long does a standard MVP engineering cycle take from brief to live deployment?", a: "Depending on your targeted feature criteria, our core engineering desk delivers structured, launch-ready web applications within 4 to 8 weeks. Our roadmap is built explicitly to trim timeline friction so you can face active consumers faster." },
    { q: "Will this MVP code need to be completely rewritten when our business scales up?", a: "Absolutely not. Because we build with strict TypeScript type-safety parameters, Next.js server-side modular routing, and decoupled database interfaces, your core engine serves as a permanent, enterprise-grade foundation for future development teams." },
    { q: "Can we integrate analytics and conversion pixel tracking from step one?", a: "Yes. Every application layout we design can include integrated hooks for system performance logs, user behavioral heatmaps, and custom tracking events to supply your business validation desk with live metrics." }
  ];
      ...
      <main className="max-w-7xl mx-auto pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto space-y-6 mb-24" data-aos="fade-up">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-[1.1]">
            MVP Development <br />
            <span className="text-[#636B2F]">for High-Growth Startups</span>
          </h1>
          <p className="text-base md:text-lg text-[#3D4127]/80 font-medium leading-relaxed max-w-3xl">
            Accelerate your market delivery parameters without introducing brittle logic or architectural debt. We engineer clean, highly cohesive codebases optimized for rapid feature pivots, secure operational scaling, and seamless investor demonstration states.
          </p>
          <div className="pt-4">
        ...
        <div className="max-w-4xl mx-auto mb-28 space-y-8">
          <div className="text-center space-y-2" data-aos="fade-up">
            ...
            <p className="text-xs md:text-sm text-[#3D4127]/60 font-medium">Quick tactical answers regarding development, protection pipelines, and validation parameters.</p>
          </div>
        ...
        >
          ...
          <div className="max-w-xl mx-auto space-y-4 relative z-10">
            ...
            <p className="text-xs md:text-sm text-white/80 font-medium leading-relaxed">
              Sync up with our web engineering architecture desk to prioritize your platform roadmap, record data schema structures, and map out your launch milestones.
            </p>
            <div className="pt-2">
